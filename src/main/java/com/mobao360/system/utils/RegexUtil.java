...
public class RegexUtil {
   public static void beanValidate(BindingResult bindingResult) {
      if (bindingResult.hasErrors()) {
         ...
         throw new MobaoException(fe.getDefaultMessage());
      }
   }
   ...
   public static boolean validateParams(Object...param){
      for(Object paramsObj :param){
         ...
         if(paramsObj instanceof java.lang.String && StringUtils.isEmpty(String.valueOf(paramsObj))){
            return false;
         }
      }
      return true;
   ...
   public static boolean validateParam(Object param){
      ...
      if(param instanceof java.lang.String && StringUtils.isEmpty(String.valueOf(param))){
         return false;
      }
      return true;
   }
